	...
	public void process(Object o) {
		...
		try {
			...
			if (smallPage.indexOf("<definitions") != -1) {
				...
				URL homepage = new URL(pageURL.getProtocol(), pageURL.getHost(), ""); // leave filename blank
				filename = ((URLQueue) queue).getFilenamePrefix() + serviceId + "-" + homepage.getHost() + ".html";
